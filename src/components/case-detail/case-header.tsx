...
export function CaseHeader({
  ...
  return (
    <div>
      <Link
        href="/cases"
        className="mb-4 inline-flex items-center gap-1 text-sm text-subtle hover:text-primary transition-colors"
      >
      ...
      <h1 className="text-2xl font-bold text-heading">{caseData.subject}</h1>
